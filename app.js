...
document.getElementById("mainInput").addEventListener("click", () => {
  ...
  if (firstWeight2 == lastWeight2) {
    title.innerHTML = ` <div class="card" style="background-color: chartreuse;">
                        ...
                        <p class="card-text mt-4" style="text-size:20px;" style="font-size: 25px;font-weight: bold;" >${
                          "Your weight is : " + firstWeight2
                        }</p>
                       </div>
                      </div>  
            `;
    ...
    title.innerHTML = `
                        ...
                        <p class="card-text" >${
                          "You lost your weight by : " +
                          (firstWeight2 - lastWeight2)
                        }</p>
                       </div>
                </div>
            `;
    ...
    title.innerHTML = `
                        ...
                        <p class="card-text" >${
                          "Your weight increase by : " +
                          (lastWeight2 - firstWeight2)
                        }</p>
                       </div>
                     </div>  
            `;
